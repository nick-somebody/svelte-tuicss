...
<dialog bind:this={dialog} style:padding={0} on:close>
  <div class="tui-modal-container active" aria-label={modalTitle}>
        ...
        <fieldset class="tui-fieldset">
          ...
          <div class="tui-modal-controls">
            <TuiButton
              ...
              class="tui-modal-close-button right"
              color={MildColor.Cyan}
