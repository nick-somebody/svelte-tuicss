...
<div
  ...
  {...$$restProps}
>
  <div class:tui-chart-display={true} class:no-x-axis={!hasLabels} class:no-y-axis={!hasLabels}>
  ...
  {#if hasLabels}
    <div
      ...
      class:tui-chart-y-axis={true}
      class:tui-chart-vertical-axis={!horizontal}
    >
      {#if horizontal}
